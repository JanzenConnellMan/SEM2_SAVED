...
setwd("C:/Users/smith/Desktop/Uchicago Research/Tim Comp Col Idea/Manuscript file - when does CNDD Reduce/Manuscript Files -- Paper 2 (Different Assumptions)/SEM2 Outputs")

write.csv(df.PropsM,"TS_v10_A275_Y45.csv",quote=F,row.names=F)
write.csv(Mat.S,"DIST_v10_A275_Y45.csv",quote=F,row.names=F)
